var myChart13 = echarts.init(document.getElementById('line13'));
...
function tooltipFormatter(params) {
    ...
    if (params.componentSubType == 'pie') {
        valuesFormatter.push(
            ...
            option13.angleAxis.data[weekDay].value + '<br>' + '</div>' +
...
myChart13.on('click', function(params) {
    if (params.componentSubType != 'pie') {
        ...
        option13.series[3].data[0].value = data[0].value[weekDay];
        option13.series[3].data[1].value = data[1].value[weekDay];
        option13.series[3].data[2].value = data[2].value[weekDay];
        ...
        option13.angleAxis.data = weekDayData;
